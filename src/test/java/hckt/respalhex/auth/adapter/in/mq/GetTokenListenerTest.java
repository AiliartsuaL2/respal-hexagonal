...
class GetTokenListenerTest {
    ...
    class HandleLoginRequest {
        ...
        void test2() {
            ...
            // then
            assertThat(response).isEqualTo(ErrorMessage.INVALID_MEMBER_ID_EXCEPTION.getMessage());
        }
        ...
        void test3() {
            //given
            when(createTokenUseCase.create(MEMBER_ID))
                    .thenThrow(new IllegalArgumentException(ErrorMessage.NOT_EXIST_MEMBER_ID_EXCEPTION.getMessage()));
            ...
            // then
            assertThat(response).isEqualTo(ErrorMessage.NOT_EXIST_MEMBER_ID_EXCEPTION.getMessage());
        }
        ...
        void test4() {
            //given
            when(createTokenUseCase.create(MEMBER_ID))
                    .thenThrow(new IllegalStateException(ErrorMessage.NOT_EXIST_MEMBER_EXCEPTION.getMessage()));
